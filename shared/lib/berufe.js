...
exports.kategorien = exports.berufe = void 0;
exports.getBerufeByKategorie = getBerufeByKategorie;
exports.getKategorieByBeruf = getKategorieByBeruf;
exports.getBerufById = getBerufById;
exports.berufe = [
...
function getBerufeByKategorie(kategorie) {
    return exports.berufe.filter(beruf => beruf.kategorie === kategorie);
}
function getKategorieByBeruf(berufId) {
    var _a;
    return (_a = exports.berufe.find(beruf => beruf.id === berufId)) === null || _a === void 0 ? void 0 : _a.kategorie;
}
function getBerufById(berufId) {
    return exports.berufe.find(beruf => beruf.id === berufId);
}
//# sourceMappingURL=berufe.js.map