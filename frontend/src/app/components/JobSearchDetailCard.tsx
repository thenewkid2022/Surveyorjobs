...
interface JobSearchDetailCardProps {
  jobSearch: JobSearchData;
  showFullContact?: boolean; // Für eingeloggte Arbeitgeber
}

export default function JobSearchDetailCard({ jobSearch, showFullContact = false }: JobSearchDetailCardProps) {
  const { user } = useAuth();
  ...
  return (
    <div className="card shadow-sm">
      <div className="card-body">
        <h1 className="card-title h2 mb-4 text-dark">{jobSearch.beruf}</h1>
